...
viewTodo (n, todo) =
    tr []
       ...
       , td [ onClick ( OpenTodoDetail n ), attribute "uk-toggle" "target: #todo-detail" ] [ text todo.title ]
...
viewTodoDetail model =
    ...
    in
        section [ id "todo-detail", class "uk-width-2-5 uk-margin-medium-top", attribute "uk-offcanvas" "flip: true; overlay: true" ]
